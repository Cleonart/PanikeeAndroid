...
class SoundClassifier(context: Context, private val options: Options = Options()) :
  ...
  class Options constructor(
    ...
    val modelPath: String = "panikee_model.tflite",
